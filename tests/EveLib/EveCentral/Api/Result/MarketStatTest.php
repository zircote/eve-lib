...
class EveLib_EveCentral_Api_Result_MarketStatTest extends PHPUnit_Framework_TestCase {
...
EOF;
 	...
 	public function testMarketStat(){
 		...
 		$out = new EveLib_EveCentral_Api_Result_MarketStat($this->sharedFixture);
