...
class EveLib_Ccp_Api_Result_Corp_AssetListTest 
...
EOF;
 	...
 	public function testAssetList(){
 		require_once 'EveLib/Ccp/Api/Result/Corp/AssetList.php';
 		$out = new EveLib_Ccp_Api_Result_Corp_AssetList($this->sharedFixture);
		...
		foreach (explode(',','itemID,typeID,quantity,flag,singleton') as $row) {
			$this->assertArrayHasKey($row, $out->result['result']['assets']['150354641']['contents']['150354709']);
		}
// 		print_r($out->result);
 	}
}