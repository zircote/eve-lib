...
class EveLib_Ccp_Api_Result_Char_StandingsTest
...
EOF;
 	...
 	public function testAccountStatus(){
 		...
 		require_once 'EveLib/Ccp/Api/Result/Char/Standings.php';
 		$out = new EveLib_Ccp_Api_Result_Char_Standings($this->sharedFixture);
// 		print_r($out->result); 
