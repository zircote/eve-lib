...
class EveLib_Ccp_Api_Result_Char_MailMessagesTest
...
EOF;
 	...
 	public function testAccountStatus(){
 		...
 		require_once 'EveLib/Ccp/Api/Result/Char/MailMessages.php';
 		$out = new EveLib_Ccp_Api_Result_Char_MailMessages($this->sharedFixture);
// 		print_r($out->result); 
