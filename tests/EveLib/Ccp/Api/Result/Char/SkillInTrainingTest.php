...
class EveLib_Ccp_Api_Result_Char_SkillInTrainingTest
...
EOF;
 	...
 	public function testAccountStatus(){
 		require_once 'EveLib/Ccp/Api/Result/Char/SkillInTraining.php';
 		$out = new EveLib_Ccp_Api_Result_Char_SkillInTraining($this->sharedFixture);
// 		print_r($out->result); 
