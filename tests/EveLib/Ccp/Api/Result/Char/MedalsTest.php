...
class EveLib_Ccp_Api_Result_Char_MedalsTest
...
EOF;
 	...
 	public function testAccountStatus(){
 		require_once 'EveLib/Ccp/Api/Result/Char/Medals.php';
 		$out = new EveLib_Ccp_Api_Result_Char_Medals($this->sharedFixture);
// 		print_r($out->result); 
