...
class EveLib_Ccp_Api_Result_Char_AccountBalanceTest
...
EOF;
 	...
 	public function testAccountStatus(){
 		//include_once 'EveLib/Ccp/Api/Result/Char/AccountBalance.php';
 		$out = new EveLib_Ccp_Api_Result_Char_AccountBalance($this->sharedFixture);
// 		print_r($out->result); 
