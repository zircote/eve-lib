...
;
        ...
        $this->credentials = array('apiKey' => TEST_API_KEY_S,
        'userID' => TEST_USERID_S, 'characterID' => TEST_CHARACTERID_S);
    ...
    public function testAccountStatus ()
    {
        ...
        $this->EveLib_Ccp_Api->getAdapter()->setResponse(
        $this->responseHeader . file_get_contents($migration));
    ...
    public function testEveCharacterInfoFull ()
    {
        ...
        $this->responseHeader . file_get_contents($migration));
        $this->EveLib_Ccp_Api->setCredentials($this->credentials);
        $data = $this->EveLib_Ccp_Api->EveCharacterInfo(array('12345',
        '123456'));
        $this->assertArrayHasKey('cachedUntil', $data['eveapi']);
         //print_r($data);
    }
