...
class EveLib_Ccp_LiveTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		EveLib_Ccp_Api::$cache = Zend_Cache::factory ( 'Core', 'File', $frontendOptions, $backendOptions );
		$this->EveLib_Ccp_Api = new EveLib_Ccp_Api();
		$this->EveLib_Ccp_Api->setCredentials(array('apiKey' => TEST_API_KEY, 'userID' => TEST_USERID, 'characterID' => TEST_CHARACTERID));
	}
