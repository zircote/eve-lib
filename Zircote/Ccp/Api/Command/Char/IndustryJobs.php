...
class Zircote_Ccp_Api_Command_Char_IndustryJobs extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/IndustryJobs.xml.aspx';

	protected $_command = 'IndustryJobs';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/IndustryJobs.php';
