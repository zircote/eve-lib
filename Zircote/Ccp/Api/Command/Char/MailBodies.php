...
class Zircote_Ccp_Api_Command_Char_MailBodies extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/MailBodies.xml.aspx';

	protected $_command = 'MailBodies';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/MailBodies.php';
