...
class Zircote_Ccp_Api_Command_Char_AccountBalance extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/AccountBalance.xml.aspx';

	protected $_command = 'AccountBalance';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/AccountBalance.php';
