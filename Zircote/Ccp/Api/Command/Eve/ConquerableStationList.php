...
class Zircote_Ccp_Api_Command_Eve_ConquerableStationList extends Zircote_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		...
		$response = new Zircote_Ccp_Api_Result_Eve_ConquerableStationList($response);
		return $response;
	}
