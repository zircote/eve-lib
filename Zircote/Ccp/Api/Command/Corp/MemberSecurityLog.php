...
class Zircote_Ccp_Api_Command_Corp_MemberSecurityLog extends Zircote_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		...
		$response = new Zircote_Ccp_Api_Result_Corp_MemberSecurityLog($response);
		return $response;
	}
