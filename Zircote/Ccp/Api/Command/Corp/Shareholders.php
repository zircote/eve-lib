...
class Zircote_Ccp_Api_Command_Corp_Shareholders extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/corp/Shareholders.xml.aspx';

	protected $_command = 'Shareholders';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Corp/Shareholders.php';
		$response = new Zircote_Ccp_Api_Result_Corp_Shareholders($response);
		return $response;
	}
