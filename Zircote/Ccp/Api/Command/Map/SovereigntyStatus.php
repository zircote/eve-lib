...
class Zircote_Ccp_Api_Command_Map_SovereigntyStatus extends Zircote_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		...
		$response = new Zircote_Ccp_Api_Result_Map_SovereigntyStatus($response);
		return $response;
	}
