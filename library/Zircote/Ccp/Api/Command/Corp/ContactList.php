...
class Zircote_Ccp_Api_Command_Corp_ContactList extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/corp/ContactList.xml.aspx';

	protected $_command = 'ContactList';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Corp/ContactList.php';
		$response = new Zircote_Ccp_Api_Result_Corp_ContactList($response);
		return $response;
	}
