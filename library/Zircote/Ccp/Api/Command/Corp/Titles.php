...
class Zircote_Ccp_Api_Command_Corp_Titles extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/corp/Titles.xml.aspx';

	protected $_command = 'Titles';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Corp/Titles.php';
		$response = new Zircote_Ccp_Api_Result_Corp_Titles($response);
		return $response;
	}
