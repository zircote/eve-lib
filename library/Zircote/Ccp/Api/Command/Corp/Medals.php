...
class Zircote_Ccp_Api_Command_Corp_Medals extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/corp/Medals.xml.aspx';

	protected $_command = 'Medals';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Corp/Medals.php';
		$response = new Zircote_Ccp_Api_Result_Corp_Medals($response);
		return $response;
	}
