...
class Zircote_Ccp_Api_Command_Corp_MarketOrders extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/corp/MarketOrders.xml.aspx';

	protected $_command = 'MarketOrders';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Corp/MarketOrders.php';
		$response = new Zircote_Ccp_Api_Result_Corp_MarketOrders($response);
		return $response;
	}
