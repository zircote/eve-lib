...
class Zircote_Ccp_Api_Command_Corp_OutpostList extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/corp/OutpostList.xml.aspx';

	protected $_command = 'OutpostList';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Corp/OutpostList.php';
		$response = new Zircote_Ccp_Api_Result_Corp_OutpostList($response);
		return $response;
	}
