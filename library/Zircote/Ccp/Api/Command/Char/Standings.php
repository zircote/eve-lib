...
class Zircote_Ccp_Api_Command_Char_Standings extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/Standings.xml.aspx';

	protected $_command = 'Standings';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/Standings.php';
