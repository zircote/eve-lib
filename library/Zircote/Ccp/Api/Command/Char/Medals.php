...
class Zircote_Ccp_Api_Command_Char_Medals extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/Medals.xml.aspx';

	protected $_command = 'Medals';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/Medals.php';
