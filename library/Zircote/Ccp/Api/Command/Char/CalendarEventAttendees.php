...
class Zircote_Ccp_Api_Command_Char_CalendarEventAttendees extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/CalendarEventAttendees.xml.aspx';

	protected $_command = 'CalendarEventAttendees';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/CalendarEventAttendees.php';
