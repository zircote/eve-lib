...
class Zircote_Ccp_Api_Command_Char_Research extends Zircote_Ccp_Api_Command_Abstract {
	
	public $path = '/char/Research.xml.aspx';

	protected $_command = 'Research';
	
	public function _parseResponse($response){
		require_once 'Zircote/Ccp/Api/Result/Account/Research.php';
