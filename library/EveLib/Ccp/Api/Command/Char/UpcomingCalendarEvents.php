...
class EveLib_Ccp_Api_Command_Char_UpcomingCalendarEvents extends EveLib_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		require_once 'EveLib/Ccp/Api/Result/Account/UpcomingCalendarEvents.php';
