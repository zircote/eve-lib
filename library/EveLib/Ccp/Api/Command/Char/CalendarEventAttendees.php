...
class EveLib_Ccp_Api_Command_Char_CalendarEventAttendees extends EveLib_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		//require_once 'EveLib/Ccp/Api/Result/Account/CalendarEventAttendees.php';
