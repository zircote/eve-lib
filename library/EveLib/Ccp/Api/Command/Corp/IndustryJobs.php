...
class EveLib_Ccp_Api_Command_Corp_IndustryJobs extends EveLib_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		require_once 'EveLib/Ccp/Api/Result/Corp/IndustryJobs.php';
		$response = new EveLib_Ccp_Api_Result_Corp_IndustryJobs($response);
		return $response;
	}
