 ...
 *
 */
class EveLib_Ccp_Api_Command_Corp_WalletTransactions extends EveLib_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		...
		$response = new EveLib_Ccp_Api_Result_Corp_WalletTransactions($response);
		return $response;
	}
	...
	public function _getRequest(){
		...
		if(isset($this->_args[0])){
			...
			throw new EveLib_Ccp_Api_Exception('accountKey is required to execute this method', 500);
		}
