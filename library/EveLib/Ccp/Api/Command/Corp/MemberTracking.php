...
class EveLib_Ccp_Api_Command_Corp_MemberTracking extends EveLib_Ccp_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		...
		$response = new EveLib_Ccp_Api_Result_Corp_MemberTracking($response);
		return $response;
	}
