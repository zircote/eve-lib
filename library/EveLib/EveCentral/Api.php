...
class EveLib_EveCentral_Api {
	...
	protected static $_commands = array (
		'evemon' => 'EveLib_EveCentral_Api_Command_EveMon',
		'quicklook' => 'EveLib_EveCentral_Api_Command_QuickLook',
		'marketstat' => 'EveLib_EveCentral_Api_Command_MarketStat',
		'uploadsuggest' => 'EveLib_EveCentral_Api_Command_UploadSuggest'
	);
    ...
    public function setOption($name, $value) {
        ...
        if (!property_exists($this, $lowerName)) {
        	require_once 'EveLib/EveCentral/Api/Exception.php';
            throw new EveLib_EveCentral_Api_Exception("'[$lowerName]' is not a valid property/option.");
        }
    ...
    public function setConnection($options){
 		require_once 'EveLib/EveCentral/Api/Connection.php';
    	$this->_connection = new EveLib_EveCentral_Api_Connection($options);
    	return $this;
    }
    ...
    /**
     * 
     * @throws EveLib_EveCentral_Api_Exception
     * @param string $name      Command name 
     * @param array  $arguments Command arguments
     * @return EveLib_EveCentral_Api_Command_Abstract
     */
    public function getCommand($name, $args) {
		$lowerName = strtolower($name);
        if (!isset(self::$_commands[$lowerName])) {
        	require_once 'EveLib/EveCentral/Api/Exception.php';
            throw new EveLib_EveCentral_Api_Exception("Command '$name' not found");
        }
        $classParent = 'EveLib_EveCentral_Api_Command_';
        if (strpos(self::$_commands[$lowerName],$classParent ) === 0) {
        	require_once $file_path ='EveLib/EveCentral/Api/Command/'. 
