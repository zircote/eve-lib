 ...
 */
require_once 'EveLib/EveCentral/Api/Command/Interface.php';

abstract class EveLib_EveCentral_Api_Command_Abstract implements EveLib_EveCentral_Api_Command_Interface {
	
	/**
	 * 
	 * @var EveLib_EveCentral_Api
	 */
	public $_api;
	...
	public function __construct(EveLib_EveCentral_Api $api, $name, $args){
		$this->_api = $api;
		$this->_args = $args;
	}
