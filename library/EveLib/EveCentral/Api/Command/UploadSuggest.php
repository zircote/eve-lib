...
class EveLib_EveCentral_Api_Command_UploadSuggest extends EveLib_EveCentral_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		require_once 'EveLib/EveCentral/Api/Result/UploadSuggest.php';
		$response = new EveLib_EveCentral_Api_Result_UploadSuggest($response);
		return $response;
	}
	...
	public function _getRequest(){
		...
		if(isset($this->_args[0])){
			...
			throw new EveLib_EveCentral_Api_Exception('typeid [The type ID to be queried] is required', 500);
		}
		return $args;
	}
