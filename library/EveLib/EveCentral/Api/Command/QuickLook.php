...
class EveLib_EveCentral_Api_Command_QuickLook extends EveLib_EveCentral_Api_Command_Abstract {
	...
	public function _parseResponse($response){
		...
		$response = new EveLib_EveCentral_Api_Result_QuickLook($response);
		return $response;
	}
