...
class EveLib_EveCentral_Api_Connection {
	...
	public function setUri($uri){
		...
		if(!Zend_Uri::check($uri)){
			...
			throw new EveLib_EveCentral_Api_Exception("URI provided is inValid [{$url}]", 500);
		}
		$this->_uri = $uri;
		return $this;
	}
	...
	public function handle(EveLib_EveCentral_Api_Command_Abstract $command){
