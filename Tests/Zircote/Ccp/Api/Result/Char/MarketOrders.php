...
class Tests_Zircote_Ccp_Api_Result_Char_MarketOrders
...
EOF;
 	...
 	public function testAccountStatus(){
 		require_once 'Zircote/Ccp/Api/Result/Char/MarketOrders.php';
 		$out = new Zircote_Ccp_Api_Result_Char_MarketOrders($this->sharedFixture);
// 		print_r($out->result); 
